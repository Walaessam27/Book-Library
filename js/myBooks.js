    ...
    savedBooks.forEach((book) => {
      const savedBookCard = `
            <div class="my-books-list-card" data-id="${book.id}">
              <div style="cursor:pointer" class="remove-icon" data-id="${
                book.id
              ...
              <div class="card-content">
                ...
                <div class="card-content-data">
                  ...
                  <button style="cursor:pointer" class="want-to-read-button" >
                    <i style="font-size: 1.5rem" class="ri-check-line"></i><p>${
                      book.read ? "Read" : "Want to Read"
                    }</p></button>
                </div>
              </div>
            </div>`;
      ...
      readButton.addEventListener("click", function (event) {
        ...
        console.log("Book read status updated: " + book.read);
        book.read
